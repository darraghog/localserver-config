...
```
Run on the server. Trust `certs/ca.pem` on clients—see [docs/tls.md](docs/tls.md).
...
| `scripts/setup-windows-hosts.ps1` | Add darragh-pc → 127.0.0.1 in hosts (run as Admin; use if localhost works but darragh-pc doesn't) |
